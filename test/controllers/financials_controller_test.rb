...
class FinancialsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create financial" do
    assert_difference("Financial.count") do
      post financials_url, params: { financial: { community_id: @financial.community_id, description: @financial.description, period: @financial.period, price: @financial.price } }
    end
  ...
  test "should update financial" do
    patch financial_url(@financial), params: { financial: { community_id: @financial.community_id, description: @financial.description, period: @financial.period, price: @financial.price } }
